...
func (x *Http) Reset() {
	*x = Http{}
	mi := &file_proto_google_api_http_proto_msgTypes[0]
...
func (*Http) Descriptor() ([]byte, []int) {
	return file_proto_google_api_http_proto_rawDescGZIP(), []int{0}
}
...
// proto to JSON conversion must follow the [proto3 specification]
...
func (x *HttpRule) Reset() {
	*x = HttpRule{}
	mi := &file_proto_google_api_http_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HttpRule) Descriptor() ([]byte, []int) {
	return file_proto_google_api_http_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomHttpPattern) Reset() {
	*x = CustomHttpPattern{}
	mi := &file_proto_google_api_http_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomHttpPattern) Descriptor() ([]byte, []int) {
	return file_proto_google_api_http_proto_rawDescGZIP(), []int{2}
}
...
var File_proto_google_api_http_proto protoreflect.FileDescriptor

const file_proto_google_api_http_proto_rawDesc = "" +
	"\n" +
	"\x1bproto/google/api/http.proto\x12\n" +
	"google.api\"y\n" +
	"\x04Http\x12*\n" +
	...
	"\x0ecom.google.apiB\tHttpProtoP\x01Z5github.com/achtarudin/grpc-cutbray/protogen/go/google\xf8\x01\x01\xa2\x02\x04GAPIb\x06proto3"

var (
	file_proto_google_api_http_proto_rawDescOnce sync.Once
	file_proto_google_api_http_proto_rawDescData []byte
)

func file_proto_google_api_http_proto_rawDescGZIP() []byte {
	file_proto_google_api_http_proto_rawDescOnce.Do(func() {
		file_proto_google_api_http_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_google_api_http_proto_rawDesc), len(file_proto_google_api_http_proto_rawDesc)))
	})
	return file_proto_google_api_http_proto_rawDescData
}

var file_proto_google_api_http_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_google_api_http_proto_goTypes = []any{
	(*Http)(nil),              // 0: google.api.Http
	(*HttpRule)(nil),          // 1: google.api.HttpRule
	(*CustomHttpPattern)(nil), // 2: google.api.CustomHttpPattern
}
var file_proto_google_api_http_proto_depIdxs = []int32{
...
func init() { file_proto_google_api_http_proto_init() }
func file_proto_google_api_http_proto_init() {
	if File_proto_google_api_http_proto != nil {
		return
	}
	file_proto_google_api_http_proto_msgTypes[1].OneofWrappers = []any{
		(*HttpRule_Get)(nil),
		(*HttpRule_Put)(nil),
		(*HttpRule_Post)(nil),
		(*HttpRule_Delete)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_google_api_http_proto_rawDesc), len(file_proto_google_api_http_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_google_api_http_proto_goTypes,
		DependencyIndexes: file_proto_google_api_http_proto_depIdxs,
		MessageInfos:      file_proto_google_api_http_proto_msgTypes,
	}.Build()
	File_proto_google_api_http_proto = out.File
	file_proto_google_api_http_proto_goTypes = nil
	file_proto_google_api_http_proto_depIdxs = nil
}
