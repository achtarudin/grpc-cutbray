...
const file_proto_resiliency_resiliency_proto_rawDesc = "" +
	...
	"\fdummy_string\x18\x01 \x01(\tR\fdummy_string2\xf5\x02\n" +
	"\x11ResiliencyService\x12R\n" +
	"\x0fUnaryResiliency\x12\x1d.resiliency.ResiliencyRequest\x1a\x1e.resiliency.ResiliencyResponse\"\x00\x12U\n" +
	"\x10ServerResiliency\x12\x1d.resiliency.ResiliencyRequest\x1a\x1e.resiliency.ResiliencyResponse\"\x000\x01\x12U\n" +
	"\x10ClientResiliency\x12\x1d.resiliency.ResiliencyRequest\x1a\x1e.resiliency.ResiliencyResponse\"\x00(\x01\x12^\n" +
	"\x17BidirectionalResiliency\x12\x1d.resiliency.ResiliencyRequest\x1a\x1e.resiliency.ResiliencyResponse\"\x00(\x010\x01B;Z9github.com/achtarudin/grpc-cutbray/protogen/go/resiliencyb\x06proto3"
...
var file_proto_resiliency_resiliency_proto_depIdxs = []int32{
	...
	0, // 1: resiliency.ResiliencyService.ServerResiliency:input_type -> resiliency.ResiliencyRequest
	0, // 2: resiliency.ResiliencyService.ClientResiliency:input_type -> resiliency.ResiliencyRequest
	...
	1, // 5: resiliency.ResiliencyService.ServerResiliency:output_type -> resiliency.ResiliencyResponse
	1, // 6: resiliency.ResiliencyService.ClientResiliency:output_type -> resiliency.ResiliencyResponse
