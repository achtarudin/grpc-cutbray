...
import (
	google "github.com/achtarudin/grpc-cutbray/protogen/go/google"
...
type TransactionSummary struct {
	...
	TransactionDate *google.Date           `protobuf:"bytes,5,opt,name=transaction_date,proto3" json:"transaction_date,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *TransactionSummary) GetTransactionDate() *google.Date {
	if x != nil {
		return x.TransactionDate
	}
	return nil
...
const file_proto_bank_type_transaction_proto_rawDesc = "" +
	...
	"\x14TRANSACTION_TYPE_OUT\x10\x02B5Z3github.com/achtarudin/grpc-cutbray/protogen/go/bankb\x06proto3"
...
var file_proto_bank_type_transaction_proto_goTypes = []any{
	...
	(*google.DateTime)(nil),    // 3: google.type.DateTime
	(*google.Date)(nil),        // 4: google.type.Date
}
