...
type TransferResponse struct {
	...
	Timestamp         *google.DateTime       `protobuf:"bytes,6,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *TransferResponse) GetTimestamp() *google.DateTime {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
const file_proto_bank_type_transfer_proto_rawDesc = "" +
	...
	"\x06amount\x18\x04 \x01(\tR\x06amount\"\x89\x02\n" +
	...
	"\x16TRANSFER_STATUS_FAILED\x10\x02B5Z3github.com/achtarudin/grpc-cutbray/protogen/go/bankb\x06proto3"
